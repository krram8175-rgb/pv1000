// Relations & Functions — 5 Mark (Part D) board questions grouped by year.
// Each page holds one or more year-groups. Source: user-provided Karnataka II PUC papers.
export const RF_5M_PAGES = [
  ...
  [
    {
      year: "2024", tint: "indigo", questions: [
    ...
    {
      year: "2023", tint: "violet", questions: [
